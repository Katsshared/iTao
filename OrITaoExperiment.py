...
en_caexp = _('''
It is not difficult to verify that the true cause of the rotation of torsion balance in Cavendish experiment is not gravitational force between masses, but the interaction of two pairs of masses. It is amazing that this cause was not properly investigated.
...
The misfortunate attempt to invent gravitation using voltage is shown in the following video.

'''
)

de_caexp = _('''                                                                                                                                                                                
Es ist nicht schwer nachzuweisen, dass die wahre Ursache für die Drehung der Torsionswaage im Cavendish-Experiment nicht die Gravitationskraft zwischen den Massen ist, sondern die Wechselwirkung zweier Massenpaare. Es ist erstaunlich, dass diese Ursache nicht eingehend untersucht wurde.
...
Das folgende Video zeigt den missglückten Versuch, Gravitation mithilfe von Spannung zu erfinden.

'''
)

ru_caexp = _('''                                                                                                                                                                                
Нетрудно убедиться, что истинной причиной поворота крутильных весов в опыте Кавендиша является не гравитационное взаимодействие между массами, а взаимодействие двух пар масс. Удивительно, что эта причина не была должным образом исследована.
...
На следующем видео показана неудачная попытка изобрести гравитацию с помощью напряжения.
